...
>
	<div class="container mx-auto px-4 text-center">
		<h1 class="mb-6 font-serif text-4xl font-bold md:text-5xl">Contact Us</h1>
...
<section class="bg-white py-16">
	<div class="container mx-auto px-4">
		<div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
			...
			<div class="space-y-8">
				<div>
					<h2 class="mb-6 font-serif text-3xl font-bold text-[var(--color-navy)]">Get in Touch</h2>
					<ContactInfo />
				</div>
...
<section class="bg-[var(--color-neutral-50)] py-16">
	<div class="container mx-auto px-4">
		<h2 class="mb-8 text-center font-serif text-3xl font-bold text-[var(--color-navy)]">Find Us</h2>
		<Map />
	</div>
</section>
